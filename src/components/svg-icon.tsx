...
import { iconStyle, iconStyleError } from "#constants/styles.js";
...
export interface SvgIconData {
  ...
  readonly boltData: readonly string[];
  readonly boltSlashData: readonly string[];
  readonly clipboardDocumentData: readonly string[];
  readonly clipboardDocumentCheckData: readonly string[];
  readonly cog6ToothData: readonly string[];
  readonly exclamationTriangleData: readonly string[];
  readonly eyeData: readonly string[];
  readonly eyeSlashData: readonly string[];
  readonly paperAirplaneData: readonly string[];
  readonly photoData: readonly string[];
...
const svgIconData: SvgIconData = {
  ...
  boltData: ["m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z"],
